<nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-warning fixed-top shadow mx-auto rounded-5 m-3"
    style="width: 70%; transition: top 0.3s;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            ...
            <form class="d-flex mx-auto rounded-5 shadow-sm" role="search" style="width: 50%" onsubmit="return false;">
                <div class="input-group">
                    <span class="input-group-text bg-white border-end-0">
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </span>
                    <input id="searchInput" class="form-control border-start-0" type="search"
                        placeholder="Cari produk, varian, ukuran..." aria-label="Search">
                </div>
            </form>
        </div>
    </div>
