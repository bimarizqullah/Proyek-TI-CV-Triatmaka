<section id="testimoni" class="search-section position-relative py-5" style="background-color: #f4d001;">
    ...
    <div class="container position-relative z-2" data-aos="fade-up" data-aos-duration="200">
        ...
        <div class="row g-4 justify-content-center">
            @foreach ($testimoni as $index => $item)
                <div class="col-md-4 testimoni-item"
                    data-testimoni="{{ strtolower($item->nama_pelanggan . ' ' . $item->catalog->produk . ' ' . $item->deskripsi) }}"
                    ...
                    <div class="bg-white rounded-4 shadow-lg text-center h-100 card-hover">
                        <div class="image-container mb-3 position-relative">
                            ...
                            <div class="overlay-text">
                                ...
                                <h6 class="text-light" style="font-size: 0.9rem;">Produk: {{ $item->catalog->produk }}
                                    ({{ $item->catalog->variant }})</h6>
