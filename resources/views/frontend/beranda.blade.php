...
@section('content')
    ...
    <div class="position-relative" data-aos="fade-in" data-aos-duration="1000">
        <div class="d-flex justify-content-center align-items-center min-vh-100 position-relative"
            ...
            <div id="scrollGradient" class="position-absolute bottom-0 start-0 w-100"
                style="height: 250px; background: linear-gradient(to bottom, rgba(255, 255, 230, 0) 0%, #f4d001 90%); opacity: 0; transition: opacity 0.5s ease; z-index: 3;">
            </div>
        </div>
